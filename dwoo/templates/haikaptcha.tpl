...
<span class="ex"><img onclick="haiku('{{ answer1 }}');" src="/images/captcha/{{ answer1 }}.png" /></span>
<span class="ex"><img onclick="haiku('{{ answer2 }}');" src="/images/captcha/{{ answer2 }}.png" /></span>
<span class="ex"><img onclick="haiku('{{ answer3 }}');" src="/images/captcha/{{ answer3 }}.png" /></span>
<span class="ex"><img onclick="haiku('{{ answer4 }}');" src="/images/captcha/{{ answer4 }}.png" /></span>
